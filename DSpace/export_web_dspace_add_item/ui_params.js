...
$("#export-data-dspace-additem_url").change(function() {
	add_div.hide();
	$("#export-data-dspace-additem_status").empty().append("Trying to connect...")
	function success() {
		$("#export-data-dspace-additem_status").empty().append("DSpace responded OK").addClass("alert alert-success");
		$("#export-data-dspace-additem_hidden").show()
	};
	function fail(msg) {
		$("#export-data-dspace-additem_status").empty().append("Connection failed!")
